...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if(!$nameError && !$emailError && !$messageError && !$documentError){ 
        ...
        // ادخال المعلومات بواسطة الامر prepare الي يسمح بتحضير المعلومات قبل الارسال 
        $statement = $mysqli->prepare("insert into messages (contact_name, email, document,message,service_id) values (?,?,?,?,?)"); 

        //  string s, integer i, double d, binary b الرموز الموجودة تبين التالي 
       ...
       // ادحال المعلومات الى قاعدة البيانات مباشرة
